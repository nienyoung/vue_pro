<template>
	<div class="manage tc">
		...
		<div class="input-area" v-show="showAdd">
			<input type="text" placeholder="请输入图书名称" v-model="nameValue">
		...
		<div class="wrap" v-show="showEdit">
			<div class="content">
				<input type="text" placeholder="请输入图书名称" v-model="newName">
	...
	export default{
		...
		data(){
			return{
				...
				showAdd: false,
				showEdit: false,
				books: [{'name':'红楼梦'},{'name':'西游记'},{'name':'水浒传'},{'name':'三国演义'}],
				nameValue: '',
				newName: '',
				editId: 0
			}
...
<style>
	...
	.manage >button{width:200px; height:40px; line-height:40px; background-color:#4682b4; border: none; border-radius:5px; font-size:16px; color:#fff;}
	...
	.input-area button{ width:60px; height: 40px; line-height:40px; background-color:#4682b4; border: none; border-radius:5px; font-size:16px; color:#fff;}
	th,td{width:100px;}
	...
	.wrap .content button{width:100px; height: 30px; line-height: 30px; background-color:#4682b4; border: none; border-radius:5px; font-size:16px; color:#fff;}
</style>